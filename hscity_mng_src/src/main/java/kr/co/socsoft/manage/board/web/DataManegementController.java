...
public class DataManegementController {
    ...
    @RequestMapping(value = "/dataManegement/list.do")
    public String boardList(Model model, @ModelAttribute("searchVO") BoardVO boardVO) throws Exception {
        ...
        items = manageBoardService.selectDataManegementBoardList(boardVO);
        totCnt = manageBoardService.selectDataManegementBoardListToCnt(boardVO);
        ...
        return "/admin/board/dataManegement/dataManegementList";
    }

    @RequestMapping(value = "/dataManegement/view.do")
    public String boardView(Model model, @ModelAttribute("searchVO") BoardVO boardVO) {
        model.addAttribute("result", manageBoardService.selectDataManegementBoard(boardVO));
        model.addAttribute("type", "board");

        return "/admin/board/dataManegement/dataManegementView";
    }

    @RequestMapping(value = "/dataManegement/addView.do")
    public String boardAddView(Model model, @ModelAttribute("searchVO") BoardVO boardVO) throws Exception {
        ...
        return "/admin/board/dataManegement/dataManegementRegist";
    }

    @RequestMapping(value = "/dataManegement/add.do")
    public String boardAdd(Model model,BoardVO boardVO, BindingResult bindingResult) throws Exception {
        ...
        int insertCount = manageBoardService.insertDataManegementBoard(boardVO);
        model.addAttribute("seq", boardVO.getSeq());
        return "redirect:/admin/board/dataManegement/view.do";
    }

    @RequestMapping(value = "/dataManegement/updateView.do")
    ...
    @RequestMapping(value = "/dataManegement/update.do")
    public String boardUpdate(Model model, BoardVO boardVO, BindingResult bindingResult) throws Exception {
        ...
        int updateCount = manageBoardService.updateDataManegementBoard(boardVO);
        boardVO = manageBoardService.selectDataManegementBoard(boardVO);
    ...
    @RequestMapping(value = "/dataManegement/delete.do")
    public String boardDelete(BoardVO boardVO) {
        int deleteCount = manageBoardService.deleteDataManegementBoard(boardVO);
        return "redirect:/admin/board/dataManegement/list.do";
    }
