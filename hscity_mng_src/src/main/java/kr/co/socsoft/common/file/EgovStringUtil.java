package kr.co.socsoft.common.file;
...
/**
	 ...
	 * @author Yery
	 * @date 2013. 1. 31.
	 * @desc 왼쪽으로 특정 문자 수 채움
	 *
	 */
	public static String padLeft( String src, int FixSize, String szFlag )
	{	
		if ( src == null ) src = "";
		
		String szRet = "";
		
		if ( FixSize < src.length() ) src = (src.substring(0, FixSize)).trim();
		
		for ( int i = 0 ; i < FixSize - src.length() ; i++ )
		{
			szRet = szFlag + szRet;
		}
