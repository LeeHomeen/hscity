...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('tbody td.align-l a').on('click', function(){
            ...
            $searchForm.attr('action', '<c:url value="/admin/board/qa/view.do"/>');
            $searchForm.submit();
        });
        ...
        $('#btnSearch').on('click', function(){
            $('#pageIndex').val(1);
            $searchForm.attr('action', '<c:url value="/admin/board/qa/list.do"/>');
            $searchForm.submit();
        });
        ...
        <div class="sec-right">
            ...
            <div class="top-bar">
                ...
                <div class="path-wrap">
                    ...
                    <span class="now">Q&A</span>
                </div>
                <div class="clearfix">
                    <p class="tit-page">Q&A</p>
                </div>
            </div>
            <!-- //상단 경로 및 페이지 타이틀 -->
            ...
            <div class="cont">
                ...
                <table class="tbl sr1 st1">
                    <caption class="hide">Q&A 게시판 표</caption>
                    <colgroup>
                        <col style="width:8%"/>
                        <col style="width:15%"/>
                        <col style="width:15%"/>
                        ...
                        <c:if test="${paginationInfo.totalRecordCount > 0}">
                            <c:forEach items="${items}" var="item">
                                <tr>
                                    ...
                                    <td scope="row">${fn:length(item.answers) > 0 ? '답변완료' : '처리중'}</td>
                                    <td class="align-l">
