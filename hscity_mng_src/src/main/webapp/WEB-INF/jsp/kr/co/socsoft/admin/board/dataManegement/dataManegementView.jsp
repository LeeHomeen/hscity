...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('#btnList').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/dataManegement/list.do"/>');
            $boardVO.submit();
        });

        // 수정
        $('#btnEdit').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/dataManegement/updateView.do"/>');
            $boardVO.submit();
        });
        ...
        $('#btnDelete').on('click', function(){
            if(confirm('<spring:message code="common.delete.msg"/>')) {
                $boardVO.attr('action', '<c:url value="/admin/board/dataManegement/delete.do"/>');
                $boardVO.submit();
            }
        });
