...
$(document).ready(function(){
    ...
    $('.board-title').on('click', function(){
        ...
        $searchVO.attr('action', '<c:url value="/internal/qa/newQaView.do"/>');
        $searchVO.submit();
    });
    ...
    $('#btnSearch').on('click', function(){
        $('#pageIndex').val(1);
        $searchVO.attr('action', '<c:url value="/internal/qa/newQaList.do"/>');
        $searchVO.submit();
    });

    // 글쓰기
    $('#btnAdd').on('click', function(){
        $searchVO.attr('action', '<c:url value="/internal/qa/newAddView.do"/>');
        $searchVO.submit();
    });
