...
<head>
  ...
  <title>화성시 대중교통 표준모델 공간분석</title>
 ...
 <body>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			searchJspPage("/gis/map.do", {flag:'traffic'}, false, "gis-container"); //content
			searchJspPage("/gis/menu.do", {flag:'traffic'}, false, "gis-gnb"); //gisPopup side menu 호출			
			searchJspPage("/gis/search.do", {flag:"traffic", menu:"blind"}, false, "gis-lnb"); //gisPopup side search 호출
			searchJspPage("/gis/result.do", {flag:"traffic", menu:"blind"}, false, "gis-result");
			searchJspPage("/gis/top.do", {flag:'traffic'}, false, "header"); //gisPopup top 호출
			searchJspPage("/gis/popup.do", {flag:'traffic'}, false, "gis-popup"); //gisPopup top 호출
