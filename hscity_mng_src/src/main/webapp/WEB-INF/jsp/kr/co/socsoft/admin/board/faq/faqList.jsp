...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('tbody td.align-l a').on('click', function(){
            ...
            $searchForm.attr('action', '<c:url value="/admin/board/faq/view.do"/>');
            $searchForm.submit();
        });

        // 글쓰기
        $('#btnAddView').on('click', function(e){
            $searchForm.attr('action', '<c:url value="/admin/board/faq/addView.do"/>');
            $searchForm.submit();
        });
        ...
        $('#btnSearch').on('click', function(){
            $('#pageIndex').val(1);
            $searchForm.attr('action', '<c:url value="/admin/board/faq/list.do"/>');
            $searchForm.submit();
        });
        ...
        <div class="sec-right">
            ...
            <div class="cont">
                ...
                <table class="tbl sr1 st1">
                    <caption class="hide">FAQ 게시판 표</caption>
                    <colgroup>
                        <col style="width:8%"/>
                        <col style="width:10%"/>
