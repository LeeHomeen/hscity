...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('tbody td.align-l a').on('click', function(){
            ...
            $searchForm.attr('action', '<c:url value="/admin/board/leehomeen/view.do"/>');
            $searchForm.submit();
        });

        // 글쓰기
        $('#btnAddView').on('click', function(e){
            $searchForm.attr('action', '<c:url value="/admin/board/leehomeen/addView.do"/>');
            $searchForm.submit();
        });
        ...
        $('#btnSearch').on('click', function(){
            $('#pageIndex').val(1);
            $searchForm.attr('action', '<c:url value="/admin/board/leehomeen/list.do"/>');
            $searchForm.submit();
        });
