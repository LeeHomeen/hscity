...
$(document).ready(function(){
    ...
    $('#btnExcel').on('click', function(){
        if(confirm('데이터를 엑셀로 내려받으시겠습니까?\n데이터 건수가 많을 경우 오래 걸릴 수 있습니다.')) {
            ...
            CM.downloadFileWithIFrame($('body'), '<c:url value="/stats/userAccess/getUserAccessCountExcel.do"/>', $('#searchVO').serializeObject());
        }
    });
    ...
    function initGrid($grid) {
        ...
        colModels[colIndex++]={name: "connDt", index: "conn_dt", comments: "접속일자", width: 170, align: "center", hidden: false};
        colModels[colIndex++]={name: "userId", index: "user_id", comments: "사용자ID", width: 170, align: "center", hidden: false};
        colModels[colIndex++]={name: "userNm", index: "user_nm", comments: "사용자이름", width: 170, align: "center", hidden: false};
        colModels[colIndex++]={name: "connIp", index: "conn_ip", comments: "접속아이피", width: 170, align: "center", hidden: false};
        colModels[colIndex++]={name: "connBrowser", index: "conn_browser", comments: "접속브라우저", width: 170, align: "center", hidden: false};
        ...
        $grid.jqGrid({
            url: '<c:url value="/stats/userAccess/getUserAccessCountList.do"/>',
            datatype: "json",
            mtype: 'get',
            postData: $("form[name='searchVO']").serializeObject(),
        ...
        <div class="sec-right">
            ...
            <div class="top-bar">
                <div class="path-wrap">
                    ...
                    <span class="now">내부사용자 접속통계</span>
                </div>
                <div class="clearfix">
                    <p class="tit-page">내부사용자 접속통계</p>
                </div>
            </div>
            <!-- //상단 경로 및 페이지 타이틀 -->
                        ...
                        <fieldset>
                            ...
                            <div class="right">
                                    ...
                                    <select class="ip sr1 st1 w1" name="searchField">
                                        ...
                                        <option value="conn_browser">접속브라우저</option>
                                    </select>
                                <label>
