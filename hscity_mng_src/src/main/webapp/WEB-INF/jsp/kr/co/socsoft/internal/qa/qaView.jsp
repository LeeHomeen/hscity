...
$(document).ready(function(){
    ...
    $('#btnList').on('click', function(){
        $boardVO.attr('action', '<c:url value="/internal/qa/list.do"/>');
        $boardVO.submit();
    });
    ...
    $('#btnUpdate').on('click', function() {
        if(confirm("<spring:message code='common.update.msg'/>")) {
            $boardVO.attr('action', '<c:url value="/internal/qa/updateView.do"/>');
            $boardVO.submit();
        }
    });
});
...
<div class="AllWrap">
    ...
    <div class="contentWrap">
        ...
        <h3 class="stitle"><img src="<c:url value="/images/biz/icon_qna.png"/>" alt="" class="bl">질의응답 내역</h3>
        ...
        <div class="subContentWrap">
            <div class="subContent">
                ...
                <c:if test="${result.answers[0] != null}">
                    ...
                    <table class="tbl_view" summary="답변내역">
                        ...
                        <tr>
                            <th scope="row">작성자</th>
                            <td class="ft_black">${result.answers[0].createNm}</td>
                            <th class="l_line" scope="row">답변 등록일</th>
                            <td class="ft_black">${result.answers[0].createDt}</td>
                        </tr>
                        <tr>
                            <th scope="row">답변내용</th>
                            <td class="ft_black" colspan="3">${result.answers[0].contents}</td>
                        </tr>
