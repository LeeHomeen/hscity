...
$(document).ready(function(){
    ...
    $('#btnList').on('click', function(){
        $boardVO.attr('action', '<c:url value="/internal/think/list.do"/>');
        $boardVO.submit();
    });
    ...
    $('#btnUpdate').on('click', function() {
        if(confirm("<spring:message code='common.update.msg'/>")) {
            $boardVO.attr('action', '<c:url value="/internal/think/updateView.do"/>');
            $boardVO.submit();
        }
    });
});
...
<div class="AllWrap">
    ...
    <div class="contentWrap">
        ...
        <h3 class="stitle"><img src="<c:url value="/images/biz/icon_idea.png"/>" alt="" class="bl">생각의 탄생 내역</h3>
