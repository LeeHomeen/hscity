...
$(document).ready(function(){
    ...
    $('.board-title').on('click', function(){
        ...
        $searchVO.attr('action', '<c:url value="/internal/think/view.do"/>');
        $searchVO.submit();
    });
    ...
    $('#btnSearch').on('click', function(){
        $('#pageIndex').val(1);
        $searchVO.attr('action', '<c:url value="/internal/think/list.do"/>');
        $searchVO.submit();
    });

    // 글쓰기
    $('#btnAdd').on('click', function(){
        $searchVO.attr('action', '<c:url value="/internal/think/addView.do"/>');
        $searchVO.submit();
    });
...
<div class="AllWrap">
    ...
    <div class="contentWrap">
        ...
        <h3 class="stitle"><img src="<c:url value="/images/biz/icon_idea.png"/>" alt="" class="bl">생각의 탄생</h3>
