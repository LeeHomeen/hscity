...
$(document).ready(function(){
    ...
    $('#btnAdd').on('click', function() {
        ...
        if(confirm("<spring:message code='common.regist.msg'/>")) {
            $boardVO.attr('action', '<c:url value="/internal/think/add.do"/>');
            $boardVO.submit();
        }
        </c:if>
        ...
        if(confirm("<spring:message code='common.update.msg'/>")) {
            $boardVO.attr('action', '<c:url value="/internal/think/update.do"/>');
            $boardVO.submit();
        }
        </c:if>
    });
...
<div class="AllWrap">
    ...
    <div class="contentWrap">
        ...
        <h3 class="stitle"><img src="<c:url value="/images/biz/icon_idea.png"/>" alt="" class="bl">생각의 탄생 등록</h3>
