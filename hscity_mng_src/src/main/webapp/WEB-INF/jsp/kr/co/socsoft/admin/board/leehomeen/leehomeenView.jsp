...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('#btnList').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/leehomeen/list.do"/>');
            $boardVO.submit();
        });

        // 수정
        $('#btnEdit').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/leehomeen/updateView.do"/>');
            $boardVO.submit();
        });
        ...
        $('#btnDelete').on('click', function(){
            if(confirm('<spring:message code="common.delete.msg"/>')) {
                $boardVO.attr('action', '<c:url value="/admin/board/leehomeen/delete.do"/>');
                $boardVO.submit();
            }
        });
