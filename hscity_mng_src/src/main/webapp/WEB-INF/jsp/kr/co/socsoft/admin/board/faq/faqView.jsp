...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('#btnList').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/faq/list.do"/>');
            $boardVO.submit();
        });

        // 수정
        $('#btnEdit').on('click', function(){
            $boardVO.attr('action', '<c:url value="/admin/board/faq/updateView.do"/>');
            $boardVO.submit();
        });
        ...
        $('#btnDelete').on('click', function(){
            if(confirm('<spring:message code="common.delete.msg"/>')) {
                $boardVO.attr('action', '<c:url value="/admin/board/faq/delete.do"/>');
                $boardVO.submit();
            }
        });
        ...
        <div class="sec-right">
            ...
            <div class="top-bar">
                <div class="path-wrap">
                    ...
                    <span class="now">FAQ 상세보기</span>
                </div>
                <div class="clearfix">
                    <p class="tit-page">FAQ 상세보기</p>
                </div>
            </div>
            <!-- //상단 경로 및 페이지 타이틀 -->
            ...
            <div class="cont">
                ...
                <form id="boardVO" name="boardVO" method="post">
                    ...
                    <table class="tbl sr1 st1">
                        <caption class="hide">FAQ 글보기</caption>
                        <colgroup>
